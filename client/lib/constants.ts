export const APP_CONFIG = {
  ...
  api: {
    ...
    baseUrl: process.env.NEXT_PUBLIC_API_BASE_URL || "https://backend-alg2sispw-grochainng-6727s-projects.vercel.app",
    wsUrl: process.env.NEXT_PUBLIC_WS_URL || "https://backend-alg2sispw-grochainng-6727s-projects.vercel.app",
  },
  auth: {
