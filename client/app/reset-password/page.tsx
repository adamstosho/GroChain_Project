    ...
    <div className="mx-auto max-w-md p-6">
      <Card>
        ...
        <CardContent>
          ...
          {success && (
            <div className="flex items-center space-x-2 p-3 bg-success/10 border border-success/10 rounded-md mb-4">
          ...
          {!token && (
            <div className="flex items-center space-x-2 p-3 bg-warning/10 border border-warning/10 rounded-md mb-4">
